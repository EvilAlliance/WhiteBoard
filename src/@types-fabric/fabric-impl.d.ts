...
export class EraserBrush extends PencilBrush {
    type: string;
    inverted: boolean;
    _saveAndTransform(ctx: CanvasRenderingContext2D): void;
    needsFullRender(): boolean;
    onMouseDown(pointer: fabric.Point, options: fabric.IEvent): void;
    _render(): void;
    createPath(pathData: (string | number)[][]): Path;
    applyClipPathToPath(path: fabric.Path, clipPath: fabric.Object, clipPathContainerTransformMatrix: number[]): fabric.Path;
    clonePathWithClipPath(path: fabric.Path, object: fabric.Object, callback: Function): void;
    _addPathToObjectEraser(obj: fabric.Object, path: fabric.Path): void;
    applyEraserToCanvas(path: fabric.Path): Object;
